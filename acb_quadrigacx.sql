DELIMITER //
DROP PROCEDURE IF EXISTS calc_acb_quadrigacx//

CREATE PROCEDURE calc_acb_quadrigacx()
BEGIN
 ...
 cursor_loop: LOOP
  FETCH c1 INTO v_txn_id, v_txn_type, v_quantity, v_price, v_gross_amount, v_txn_date, v_currency;
	...
	IF v_currency = v_prev_currency THEN
		...
		FROM quadrigacx_txn a
        WHERE a.row_status = 1
		AND a.txn_date < v_txn_date
		AND a.currency = v_currency;
        
        /*SELECT v_prev_quantity, v_quantity, v_prev_book;*/
